...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="YDYToolManager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14YDYToolManager14AutoScrollView")
...
SWIFT_PROTOCOL("_TtP14YDYToolManager22AutoScrollViewDelegate_")
@protocol AutoScrollViewDelegate
- (NSInteger)autoScrollViewCountWithScrollView:(AutoScrollView * _Nonnull)scrollView SWIFT_WARN_UNUSED_RESULT;
- (UIView * _Nonnull)autoScrollViewWithScrollView:(AutoScrollView * _Nonnull)scrollView index:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
@optional
- (void)autoScrollViewWithScrollView:(AutoScrollView * _Nonnull)scrollView selectedIndex:(NSInteger)selectedIndex;
@end

@class UICollectionViewLayoutAttributes;

SWIFT_CLASS("_TtC14YDYToolManager25CollectionViewScaleLayout")
@interface CollectionViewScaleLayout : UICollectionViewFlowLayout
- (void)prepareLayout;
